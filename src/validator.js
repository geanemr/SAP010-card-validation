...
maskify (ccNumber) {
    ...
    const masked = maskCCNumber.join (""); /*O método join() junta todos os elementos de um array em uma string e retorna esta string. Aqui juntamos os 4 mascarados novamente pra sequência de dígitos. */
    return masked;
    }
}
};
